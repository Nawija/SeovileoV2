                                    ...
                                    {!showLive ? (
                                        ...
                                        <div className="absolute flex items-center justify-start flex-col bg-[#eee] top-0 z-[100] left-0 w-screen h-screen">
                                            ...
                                            <div className="relative top-0 flex py-1 items-center justify-start lg:justify-center w-full bg-gray-200">
                                                <button
                                                    onClick={web1}
                                                    className="absolute top-[50%] md:top-[45%] right-5 -translate-y-1/2 py-2 text-gray-100 m-0 px-5 bg-gradient-to-tl from-red-500 to-red-700 rounded-lg shadow-lg shadow-red-500 z-50"
                                                >
                                                    Zamknij
                                                </button>
